...
";
    ...
    {
        get { return string.Format(AutoGenFormat, DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss")); }
    }

    // namespace
    public string NameSpaceTemplate
    {
        get { return string.Format("namespace {0}.{1}", PlayerSettings.companyName, PlayerSettings.productName); }
    }
